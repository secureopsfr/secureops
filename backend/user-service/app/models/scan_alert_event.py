...
class ScanAlertEvent(Base):
    ...
    scan_type = Column(String(20), nullable=False, default="frontend", comment="Type de scan : frontend, backend, both")
    scan_mode = Column(String(20), nullable=False, default="passive", comment="Mode de scan : passive, intrusive, destructive, custom")
