"""Intrusive multi-URL orchestration based on reusable pipeline base."""
...
class IntrusiveMultiScanOrchestrator(BaseMultiScanOrchestrator):
    """Initial intrusive implementation with fake page probes."""
    ...
    def get_execution_settings(self) -> MultiScanExecutionSettings:
        """Load intrusive multi-scan concurrency and timeout settings."""
    ...
    async def after_client_run(
        ...
        *,
        ...
        """Publish intrusive multi-scan HTTP metrics once execution completes."""
    ...
    async def run_domain_phase(
        ...
        """Run domain-level intrusive checks (placeholder in this first version)."""
        # Placeholder for future domain-wide intrusive checks.
        _ = client
        await self.emit_progress("intrusive_domain_checks_done", url=base_url)
    ...
    async def run_single_page(
        ...
        *,
        ...
        """Run intrusive probes for a single page and aggregate findings."""
        del page_timeout
        ...
        summaries = build_intrusive_category_summaries(findings)
    ...
    def build_final_result(
        ...
        *,
        ...
        """Build the final intrusive multi-scan payload object."""
...
async def run_multi_scan(
    ...
    """Run intrusive multi-scan orchestration for a list of URLs."""
    orchestrator = IntrusiveMultiScanOrchestrator(on_progress=on_progress)
