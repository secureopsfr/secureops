"""Tests unitaires pour le calcul de la posture TLS (app.services.tls.posture)."""

from app.services.tls.checks import TlsCheckResult
from app.services.tls.posture import POSTURE_CRITICAL, POSTURE_OK, POSTURE_WARNING, compute_tls_posture
