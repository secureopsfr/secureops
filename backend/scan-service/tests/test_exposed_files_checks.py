"""Tests unitaires pour les vérifications Exposed Files (passive)."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from app.services.passive.both.exposed_files import ExposedEndpoint, ExposedFilesCheckResult, run_exposed_files_checks
