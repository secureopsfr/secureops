"""Tests unitaires pour les vérifications robots.txt (passive)."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from app.services.passive.robots_txt import RobotsTxtCheckResult, SensitiveRoute, run_robots_txt_checks
...
async def test_run_robots_txt_checks_404() -> None:
    ...
    with patch("app.services.passive.robots_txt.checks.get_with_client", new_callable=AsyncMock) as mock_get:
