"""Point d'entrée principal du Metier B Service."""
...
setup_logging(service_name="metier-b-service")
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Démarrage du Metier B Service")
    yield
    # Shutdown
    logger.info("Arrêt du Metier B Service")
